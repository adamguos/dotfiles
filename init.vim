...
let g:ale_fixers={'python': ['black'], 'json': ['fixjson']}
let g:ale_linters={'python': ['flake8'], 'tex': []}
let g:ale_python_flake8_options = '--max-line-length=88 --ignore=E402,E741,F401,W504,E126,W503,E722,E266,E265,F841,E501'
